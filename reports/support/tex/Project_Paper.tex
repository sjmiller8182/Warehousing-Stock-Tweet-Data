...
amounts of data (multi-terabyte data-sets) \textbf{in parallel} on large clusters (thousands of nodes) of commodity hardware in a	reliable, fault-tolerant manner.
