...
With the high demand of computing power, computer architecture has evolved over the years from serial computing to parallel computing where tasks are distributed and executed simultaneously across multiple processors within the same computer. 
With MapReduce, instead of using one server instance with multiple processors, multiple servers with multiple processors are used for computation.
...
\begin{table}
	...
	\begin{tabular}{c|c|c}
		...
		\hline
		\multirow{4}{*}{S3} & \multirow{2}{*}{Normalized} & MapConfig1 / ReduceConfig1 \\
		\cline{3-3}
				            &                             & MapConfig1 / ReduceConfig2 \\
		\cline{2-3}
				            & \multirow{2}{*}{Denormalized} & MapConfig2 / ReduceConfig1 \\
		\cline{3-3}
							&		  		                & MapConfig2 / ReduceConfig2 \\
		\hline
		\multirow{4}{*}{HDFS} & \multirow{2}{*}{Normalized} & MapConfig1 / ReduceConfig1 \\
		\cline{3-3}
		                      &                             & MapConfig1 / ReduceConfig2 \\
		\cline{2-3}
		                      & \multirow{2}{*}{Denormalized} & MapConfig2 / ReduceConfig1 \\
