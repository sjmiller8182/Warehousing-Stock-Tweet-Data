...
Add the equation from \cite{OptimizeHadoop} here?
...
The two factors of the study are schema with levels of snowflake and denormalized star and
 MapReduce block size with levels of 64 MB, 128 MB, and 256 MB.
...
\begin{table}
    ...
    \begin{tabular}{c|c|c|c|c}
        ...
        \hline
        \multirow{3}{*}{Denormalized Star} & 64 MB    & & & \\
        \cline{2-5}
                                           & 128 MB   & & & \\
        \cline{2-5}
